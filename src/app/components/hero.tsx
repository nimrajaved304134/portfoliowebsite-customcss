...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col h-[calc(150vh-6rem)] md:h-[calc(100vh-9rem)] lg:flex-row '>
      ...
      <div className='flex-1 flex items-center justify-center flex-col gap-8 text-stone-700 font-bold'>
        ...
        <p className='text-1xl justify-center items-center flex text-center	'>
      ...
      <div className='w-full flex-1 flex relative justify-center items-center m-8 '>
        <Image
          ...
          className='w-full object-cover drop-shadow-2xl rounded-md justify-center items-center lg:m-24  lg:h-3/4 md:w-2/3 flex border-rose-500 border-8 border-opacity-40'
